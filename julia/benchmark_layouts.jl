...
println("\n結果を benchmark_result.txt に保存...")
open("benchmark_result.txt", "w") do f
  println(f, "メモリレイアウト: $(VERSION >= v"1.0" ? "新レイアウト(tuning2)" : "不明")")
