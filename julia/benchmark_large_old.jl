...
中規模問題でのベンチマーク（旧レイアウト版）
配列形状: 旧レイアウト (nt, ni, nj)
"""
...
println("\n結果を benchmark_large_old.txt に保存...")
open("benchmark_large_old.txt", "w") do f
  println(f, "中規模問題ベンチマーク（旧レイアウト版）")
