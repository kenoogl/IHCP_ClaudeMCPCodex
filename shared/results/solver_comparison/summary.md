...
|----------|--------|----------|------------|---------------------|
| pbicgstab | none | 10.43 s | 61 | 1.346e-02 |
| pbicgstab | diagonal | 14.21 s | 47 | 1.346e-02 |
| pbicgstab | gs | 11.08 s | 11 | 1.346e-02 |
| pcg | none | 8.96 s | 95 | 1.346e-02 |
| pcg | diagonal | 12.17 s | 81 | 1.346e-02 |
| pcg | gs | 9.52 s | 20 | 1.346e-02 |
...
5. **最終ステップ初期残差**: 全パターンで約1.346e-02と同等
   - 前処理方法による最終残差の差異はほぼなし（1.346e-02 ± 0.001e-02）
   - 反復回数が異なっても同じ精度に収束
